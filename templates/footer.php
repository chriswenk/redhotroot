        ...
        <div class="footer-above">
            <div class="container">
                <div class="row">
                    ...
                    <div class="footer-col col-md-4">
                        <h3>About RedHotRoots</h3>
                        <p>RedHotRoots is a free to use, open source Bootstrap theme created by <a href="http://redhotforex.com">RedHotRoots</a>.</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="container">
                ...
                <div class="col-lg-4">
                    ...
                    <div class="col-lg-4 text-center">
                        Copyright &copy; 2014 - Chris Wenk
                    </div>
                 <div class="col-lg-4">
