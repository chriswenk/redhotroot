...
function roots_scripts() {
  wp_enqueue_style('roots_main', get_template_directory_uri() . '/assets/css/main.min.css', false, '266f5ce629bc168480bffe205a4f430f');
  ...
  wp_register_script('rhf', get_template_directory_uri() . '/assets/js/rhf.js', array(), null, false);

  wp_enqueue_script('modernizr');
  wp_enqueue_script('jquery');
  wp_enqueue_script('roots_scripts');
  wp_enqueue_script('rhf');
